...
//          Get Birthdate working
//          format phone number better
...
namespace StudentDB
{
    public partial class frmMain : Form
    {
        ...
        private void btnAddStudent_Click(object sender, EventArgs e)
        {
            ...
            // Enable textboxes with italicized examples
        ...
        private void btnSaveChanges_Click(object sender, EventArgs e)
        {
            if (mode == "add")
            {
                ...
                else
                {
                    try
                    {
                        string query = "INSERT INTO Student VALUES (@StudentFullName, @StudentFirstName, @StudentLastName, @StudentAddress, @StudentAddressLine2," +
                        ...
                        using (SqlCommand command = new SqlCommand(query, connection))
                        {
                            ...
                            // NOTE: Other strings are validated using events during user input
